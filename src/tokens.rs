...
pub const SUUSD_MAINNET_ARBITRUM: TokenCcip = TokenCcip {
    ...
    decimals: 18,
    capacity_usd: 200_000,
    refill_per_second: 2.314,
};
...
pub const DFX_MAINNET_ARBITRUM: TokenCcip = TokenCcip {
    ...
    decimals: 18,
    capacity_usd: 5_000_000,
    refill_per_second: 57.,
};
...
pub const THE_POLYGON_AVALANCHE: TokenCcip = TokenCcip {
    ...
    decimals: 18,
    capacity_usd: 750_000,
    refill_per_second: 417.,   
};
